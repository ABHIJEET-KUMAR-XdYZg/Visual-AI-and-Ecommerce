...
shopping_keywords = [
    ...
    'Accessories', 'Anklet', 'Backpack', 'Bag', 'Bandana', 'Bangles', 'Baseball Cap', 'Beanie', 
...
def detect_labels(image_bytes):
    response = reko_client.detect_labels(Image={'Bytes': image_bytes}, MinConfidence=0)  # Set MinConfidence to 0
